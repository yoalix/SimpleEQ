...
void
LookAndFeel::drawRotarySlider(juce::Graphics& g,
                              int x,
                              int y,
                              int width,
                              int height,
                              ...
                              juce::Slider& slider)
{
  ...
  auto fillColor = enabled ? Colour(45u, 96u, 105u) : Colours::darkgrey;
  g.setColour(fillColor);
  g.fillEllipse(bounds);

  auto outlineColor = enabled ? Colour(58u, 245u, 245u) : Colours::grey;
...
void
LookAndFeel::drawToggleButton(juce::Graphics& g,
...
//==============================================================================
void
RotarySliderWithLabels::paint(juce::Graphics& g)
{
  using namespace juce;
  ...
  // g.setColour(Colour(255u, 255u, 0u));
...
juce::Rectangle<int>
RotarySliderWithLabels::getSliderBounds() const
{
...
juce::String
RotarySliderWithLabels::getDisplayString() const
{
...
void
PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
  ...
  */
  ...
  while (leftChannelFFTDataGenerator.getNumAvailbleFFTDataBlocks() > 0) {
...
ResponseCurveComponent::paint(juce::Graphics& g)
{
  ...
  g.setColour(Colour(255u, 31u, 172u));
  ...
  g.setColour(Colour(160u, 130u, 212u));
...
void
ResponseCurveComponent::resized()
{
  using namespace juce;
  ...
  for (auto gDb : gain) {
    ...
    g.setColour(gDb == 0.f ? Colour(255u, 195u, 63u) : Colours::darkgrey);
...
juce::Rectangle<int>
ResponseCurveComponent::getRenderArea()
{
  auto bounds = getLocalBounds();
...
juce::Rectangle<int>
ResponseCurveComponent::getAnalysisArea()
{
...
SimpleEqAudioProcessorEditor::SimpleEqAudioProcessorEditor(
  ...
  , peakQualitySliderAttachment(audioProcessor.apvts,
                                "Peak Quality",
                                peakQualitySlider)
  , lowCutFreqSliderAttachment(audioProcessor.apvts,
                               "LowCut Freq",
                               lowCutFreqSlider)
  , highCutFreqSliderAttachment(audioProcessor.apvts,
                                "HighCut Freq",
                                highCutFreqSlider)
  , lowCutSlopeAttachment(audioProcessor.apvts,
                          "LowCut Slope",
                          lowCutSlopeSlider)
  , highCutSlopeAttachment(audioProcessor.apvts,
                           "HighCut Slope",
                           highCutSlopeSlider)
  , lowCutBypassButtonAttachment(audioProcessor.apvts,
                                 "LowCut Bypassed",
                                 lowCutBypassButton)
  , highCutBypassButtonAttachment(audioProcessor.apvts,
                                  "HighCut Bypassed",
                                  highCutBypassButton)
  , peakBypassButtonAttachment(audioProcessor.apvts,
                               "Peak Bypassed",
                               peakBypassButton)
...
void
SimpleEqAudioProcessorEditor::resized()
{
...
SimpleEqAudioProcessorEditor::getComps()
{
  return {
